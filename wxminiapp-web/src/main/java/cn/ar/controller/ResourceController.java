...
public class ResourceController {
    ...
    public Object selBasePicByCid(@RequestBody String json,String userSessCode,String comSessCode) {
        return httpClientService.doPost(HttpUrl.getArManagementUrl("resource/selBasePicByCid",userSessCode,comSessCode),json);
    }
